					...
					<?php
						if( have_rows('general_settings_socials', 'option') ):
							...
							<div class="footer-social">
								<ul>
									<?php
										while( have_rows('general_settings_socials', 'option') ) : the_row();
					...
					<div class="footer-contact">
						...
						<?php
							if(!empty($contact_information_address_text)):
								echo $contact_information_address_text;
							endif;
						?>
						<?php
					...
					<div class="footer-contact">
						...
						<?php
							if( have_rows('hours_operation_hours_data', 'option') ):
								while( have_rows('hours_operation_hours_data', 'option') ) : the_row();
						...
						<?php
							if( have_rows('awards_associations_awards_data', 'option') ):
								...
								<ul class="award-logos">
									<?php
										while( have_rows('awards_associations_awards_data', 'option') ) : the_row();
